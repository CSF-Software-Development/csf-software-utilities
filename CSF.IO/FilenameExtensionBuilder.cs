    ...
    public class FilenameExtensionBuilder : IBuildsFilenamesWithExtensions
    {
        ...
        public string BaseName
        {
            ...
            set
            {
                ...
                if (value.Length == 0)
                    throw new ArgumentException("The base name for a file must not be an empty string.", nameof(value));
                                                     ...
                                                     char extensionCharacter = DefaultExtensionSeparator)
        {
            ...
            {
                throw new ArgumentException("The filename must not be empty", nameof(filename));
            }
